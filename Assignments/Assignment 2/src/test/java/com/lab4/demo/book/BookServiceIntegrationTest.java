...
public class BookServiceIntegrationTest {
    ...
    void findAllBooks() {
        ...
        List<BookDTO> dtos = bookService.findBooks(null);

        for (int i = 0; i < nrOfBooks; i++) {
            assertEquals(books.get(i).getId(), dtos.get(i).getId());
    ...
    void findSpecificBooks() {
        ...
        List<BookDTO> dtos = bookService.findBooks(bookDTO);
    ...
    void create(){
        ...
        List<BookDTO> allTheBooks = bookService.findBooks(null);
